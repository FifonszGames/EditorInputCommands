...
BEGIN_DEFINE_SPEC(FExistingContentBindingSpec, "CommandsExtension.ExistingContentBinding", EAutomationTestFlags::EngineFilter | EAutomationTestFlags_ApplicationContextMask)
