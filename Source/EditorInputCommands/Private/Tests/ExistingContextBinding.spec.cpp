...
BEGIN_DEFINE_SPEC(FExistingContentBindingSpec, "EditorInputCommands.ExistingContentBinding", EAutomationTestFlags::EngineFilter | EAutomationTestFlags::EditorContext)
